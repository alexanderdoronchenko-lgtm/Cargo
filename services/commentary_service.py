...
async def generate_moment_explanations(
    ...
    user_prompt = (
        ...
        "комментарий тренера, а не механический вердикт «ошибка/не ошибка». "
        ...
        "ошибка, не выдумывай похвалу самому ходу. Для СИЛЬНЫХ ХОДОВ: похвали именно "
        "то, что получилось — например, что найти этот ход было непросто, или что он "
        "тихо, без размена, решил проблему в позиции; это тоже должно быть правдиво "
        "и по существу, а не общими словами. Это будет "
